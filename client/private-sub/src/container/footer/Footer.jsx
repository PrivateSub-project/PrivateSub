    ...
    return (
        <footer class="p-4 bg-slate-200 sm:p-6 dark:bg-gray-900">
            <div className="text-center mb-28">
                <h1 className="gradient__text text-2xl font-bold">
                    Do you want more information about us ?
                </h1>
            </div>

            <div class="gradient__border md:flex md:justify-between relative">
                <div class="mb-6 md:mb-0">
                    ...
                    <span class="self-center text-sm font-normal  dark:text-white">
                        Virtual credit card
                    </span>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <span className="flex flex-col text-white">
                            <a href="#" class="hover:underline mb-4">
                                React.js
                            </a>
